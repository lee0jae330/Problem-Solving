...
<p>사건이 일어났을 때, 집 안에는 시이와 시이를 제외한 $N$명의 다른 사람들이 있었다. 케이크를 먹은 범인은 사건이 일어났을 때 집 안에 있던 사람들 중 하나이다.</p>

<p>시이는 주변을 수소문한 결과, 사건이 일어나지 않은 곳에서 사건이 일어났을 때 목격된 사람들의 이름 $M$개를 얻었다.</p>
...
<ol start="0">
	...
	<li>빠르면 케이크를 몰래 먹기 쉽기 때문에, 집에 있던 <strong>시이가 아닌</strong> $N$명의 사람들 중, 목격담이 없고 사전순으로 가장 이름이 빠른 사람이 범인이다.</li>
</ol>
...
<p>두 번째 줄에, 집 안에 있던 시이를 제외한 사람의 수 $N$이 주어진다.</p>

<p>그다음 $N$개 줄에, 집 안에 있던 시이를 제외한 $N$명 각각의 이름이 한 줄에 하나씩 주어진다. 이름은 영문 소문자로만 이루어진 $1$글자 이상 $8$글자 이하의 문자열이다.</p>

<p>그다음 줄에, 목격담의 수 $M$이 주어진다.</p>

<p>그다음 $M$개 줄에, 사건이 일어나지 않은 곳에서 목격된 사람의 이름이 주어진다.</p>
